...
class App extends Component {
  ...
  // save the old book array
  oldBooks = [...this.state.books]

  handlerForSortBooks = (buttonName) => {

    console.log(buttonName)

    if (buttonName === 'author') {
      console.log('author')

      // copy old state and put in new state
      const sortAuthor = [...this.state.books];
      console.log('old', this.state.books);
      ...
      console.log('new', sortAuthor);
      // react will change on UI elemente that is chaned in old state
      this.setState({
        books: sortAuthor

      })

    } else if (buttonName === 'pages') {
      console.log('pages')

      const sortPages = [...this.state.books]

      sortPages.sort((a, b) => b.pages - a.pages)
  ...
  `
    ...
    return (
      <div>
        ...
        <StyleDivContainer>
          <Books aboutBook={this.state.books} />
          <StyleDivContainer>

            <Button changeBook={this.handlerForSortBooks.bind(this, 'author')}>Author</Button>
            <Button changeBook={this.handlerForSortBooks.bind(this, 'pages')}  >Pages</Button>
            <Button changeBook={this.handlerForSortBooks.bind(this, 'reset')} >Reset</Button>
